...
def parse_args() -> argparse.Namespace:
    ...
    args.output_dir = args.output_dir or str(ROOT_DIR / "outputs" / f"single_cfg_{model_suffix}")
    args.save_dir = args.save_dir or str(ROOT_DIR / f"lora_model_single_cfg_{model_suffix}")
    return args
