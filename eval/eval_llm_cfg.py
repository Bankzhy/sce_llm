...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name=r"/root/autodl-tmp/sce_llm/train/unsloth/codegemma-7b-bnb-4bit",   # 你的训练结果目录
...
def evaluate():
    ...
    # ---- Write Result CSV ----
    with open("lora_model_gemmacode.csv", mode="w", newline="", encoding="utf-8") as f:
